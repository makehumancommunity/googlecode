...
Armature = {
    ...
    'toe.L' :              ("PlaneToe.L", 'foot.L', F_DEF|F_CON, L_LLEGFK, P_YZX),
    ...
    'toe.R' :              ("PlaneToe.R", 'foot.R', F_DEF|F_CON, L_RLEGFK, P_YZX),
}
...
RotationLimits = {
    ...
    'foot.L' :          (-90*D,45*D, -30*D,30*D, -30*D,30*D),
    'foot.R' :          (-90*D,45*D, -30*D,30*D, -30*D,30*D),
    'toe.L' :           (-20*D,60*D, 0,0, 0,0),
    'toe.R' :           (-20*D,60*D, 0,0, 0,0),

    'clavicle.L' :      (-16*D,50*D, -70*D,70*D,  -45*D,45*D),
    'clavicle.L' :      (-16*D,50*D,  -70*D,70*D,  -45*D,45*D),
    'upper_arm.L' :     (-45*D,135*D, -60*D,60*D, -135*D,135*D),
    'upper_arm.R' :     (-45*D,135*D, -60*D,60*D, -135*D,135*D),
    'forearm.L' :       (-70*D,130*D, 0,0, 0,0),
    'forearm.R' :       (-70*D,130*D, 0,0, 0,0),
    'hand.L' :          (-90*D,70*D, -90*D,90*D, -20*D,20*D),
    'hand.R' :          (-90*D,70*D, -90*D,90*D, -20*D,20*D),
